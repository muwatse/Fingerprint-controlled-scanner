...
void setup() {
    ...
    Serial.println("Entering SetupSequence...");
    setupSequence();
}
...
uint8_t getFingerprintEnroll() {
    ...
    clearScreen();
    screenPrint(1, "Place same finger   ");
    screenPrint(2, "  again             ");
...
void setupSequence() {
    Serial.println("Entered SetupSequence");
    ...
    Serial.println("Emptied Database, Clearing fingerprints[]...");
    for(int i = 0; i < 20; i++) {   //Clears fingerprints array of previously stored roles
        fingerprints[i] = '0';
    }
    Serial.println("Cleared fingerprints");
...
int getNumUsers() {
    ...
    clearScreen();
    screenPrint(2, "Select Use Case:    ");
    delay(100);
    screenPrint(3, "A) Independent User ");
    delay(100);
    screenPrint(4, "B) Dependent User ");
    screenPrint(1, "--------------------");
